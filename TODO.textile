...
# will SHA512 hashes fit in all the places they are being used? (db columns, sessions, emails) 128 characters
# refactor encryption out into own abstract class/module to be overwriten
